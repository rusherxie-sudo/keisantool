...
describe('schoolGrade（日本の学年）', () => {
  ...
  it('学校年度は4月1日、出生コホートは4月2日で切り替わる', () => {
    expect(schoolGrade('2020-04-02', '2027-03-31').label).toBe('未就学');
    expect(schoolGrade('2020-04-02', '2027-04-01').label).toBe('小学1年生');
    expect(schoolGrade('2021-04-01', '2027-04-01').label).toBe('小学1年生');
    expect(schoolGrade('2021-04-02', '2027-04-01').label).toBe('未就学');
  });
