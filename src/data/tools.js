...
export const tools = [
  ...
  },
  {
    slug: 'csv-mojibake',
    nav: 'CSV文字化け',
    name: 'CSV文字化け修復・文字コード変換ツール',
    icon: '📄',
    category: '文字ツール',
    short: 'Shift_JIS・UTF-8を判定してExcel向けに変換',
    live: true,
  },
  {
    slug: 'romaji-kana',
  ...
  },
  {
    ...
    icon: '✍️',
    category: '文字ツール',
    short: '空白・改行・句読点をコピペで一括整理',
    live: true,
  },
  {
    slug: 'denwa-format',
    nav: '電話番号整形',
    name: '電話番号フォーマット変換ツール',
    icon: '☎️',
    category: '変換・ツール',
    short: '日本の電話番号にハイフンを自動追加',
    live: true,
  },
  {
    slug: 'gakureki',
...
export const categoryMeta = [
  ...
  },
  {
    ...
    faq: [
      { q: 'BMIはどうやって求めますか？', a: 'BMI＝体重(kg)÷(身長(m)×身長(m)) で計算します。例えば身長170cm・体重65kgなら 65÷(1.7×1.7)≒22.5 です。「BMI計算ツール（女性・男性）」で標準体重も同時に確認できます。' },
