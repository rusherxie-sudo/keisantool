...
export const tools = [
  ...
  },
  {
    ...
    icon: '⚙️',
    category: '生活・日常',
    short: '歯数から減速比・回転数・トルク・自転車速度を計算',
    live: true,
  },
  {
    slug: 'netsuryou',
